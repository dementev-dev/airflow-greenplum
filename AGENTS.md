...
- `docs/` — документация. Подкаталоги: `design/` (дизайн, стандарты), `reference/` (справочники), `plans/` (активные планы), `archive/` (выполненные планы), `assignment/` (задание для студента).
  ...
  - Нейминг файлов планов: `YYYY-MM-DD_краткое-описание.md` (дата — ISO 8601, `_` отделяет дату от описания, описание в kebab-case, без суффикса `-plan`).
...
При создании и пересмотре лабораторных сначала прочитайте
[развитие лабораторных](docs/design/labs_development.md): аудитория,
принятые решения и критерии заданий.
