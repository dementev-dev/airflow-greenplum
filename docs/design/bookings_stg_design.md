# История проектирования STG для Bookings
...
[руководство загрузки STG](../bookings_to_gp_stage.md).
Смысл строк и связи показаны на [карте](architecture-map.html#node=stg.bookings);
...
Ниже сохранен план "Дизайн STG для bookings в Greenplum".
