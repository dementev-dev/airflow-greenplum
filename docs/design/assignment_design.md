...
## 6. Развитие лабораторных

Перед добавлением или пересмотром заданий прочитайте
[заметку о развитии лабораторных](labs_development.md): там зафиксированы
аудитория, решение по PXF-практикуму, предложения по обязательному циклу
и общие критерии подготовки заданий.
