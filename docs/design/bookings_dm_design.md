# История проектирования DM для Bookings
...
[руководство загрузки DM](../bookings_to_gp_dm.md).
Смысл строк и связи показаны на [карте](architecture-map.html#node=dm.sales_report);
...
Ниже сохранен план "План: DM-слой (Data Mart) для учебного стенда Bookings".
