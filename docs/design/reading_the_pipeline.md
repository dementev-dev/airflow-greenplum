...
Этот путь разобран в разделе [«Сборка факта продаж»](db_schema.md#сборка-факта-продаж).
На карте сплошные стрелки показывают готовые загрузки, пунктирные — ожидаемые
по ТЗ. Тип соединения и поведение при отсутствии строки описаны в карточке связи.
