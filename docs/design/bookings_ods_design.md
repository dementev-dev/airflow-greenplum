# История проектирования ODS для Bookings
...
[руководство загрузки ODS](../bookings_to_gp_ods.md).
Смысл строк и связи показаны на [карте](architecture-map.html#node=ods.airports);
...
Ниже сохранен план "ODS Layer: эталонный учебный план реализации (v3)".
